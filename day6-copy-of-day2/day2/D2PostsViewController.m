...
- (void)viewDidLoad
{
    ...
    [refreshControl addTarget:self action:@selector(checkForPosts) forControlEvents:UIControlEventValueChanged];
...
-(void) newPostViewController:(D2NewPostViewController *)newPostViewController didCreateNewPost:(Post *)post
{
    [posts addObject:post];
    [self.tableView reloadData];
